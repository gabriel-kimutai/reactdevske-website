...
export default function Events() {
  return (
    <section
      id="events"
      className="relative flex flex-col items-center justify-center w-full py-16 bg-white dark:bg-slate-700 dark:text-white md:py-20 gap-y-2 md:gap-y-5"
    >
      ...
      <div className="grid grid-cols-1 gap-y-4 md:gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 xl:gap-x-8 md:grid-cols-2 bg-[#09AFC6] dark:bg-slate-800 px-4 md:px-10 lg:px-16 py-8 md:py-14 xl:py-16">
        {events.map((event) => (
          <DisplayRC
            key={event.id}
            id={event.id}
